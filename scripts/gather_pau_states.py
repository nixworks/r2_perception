...
class GatherPAUStates(object):
    ...
    def __init__(self):
        ...
        self.joint_state.name[JOINT_LEFTEYE_YAW] = "lefteye_yaw"
        self.joint_state.name[JOINT_RIGHTEYE_YAW] = "righteye_yaw"
    ...
    def HandlePAU(self,data):
        ...
        with self.lock:
            ...
            self.joint_state.position[JOINT_LEFTEYE_YAW] = -data.m_eyeGazeLeftYaw
            self.joint_state.position[JOINT_RIGHTEYE_YAW] = -data.m_eyeGazeRightYaw
